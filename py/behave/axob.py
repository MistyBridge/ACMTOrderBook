...
class AXOB():
    ...
    # ── properties for dashboard / main.py compatibility ──────
    @property
    def tradingPhaseMarket(self):
        return self.TradingPhaseMarket

    @property
    def bid_level_tree_max(self):
        return max(self.bid_level_tree.keys()) if self.bid_level_tree else 0

    @property
    def ask_level_tree_min(self):
        return min(self.ask_level_tree.keys()) if self.ask_level_tree else 0

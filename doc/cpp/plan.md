...
- 吞吐量：**1,052,009 msg/s**（+87% vs v2.2，+1528% vs v1）
...
| **CPP v2.3 (直接解析+重构)** | **600K** | **1,052,009 msg/s** | 233K×10 消息 | **+1528% vs v1** |
...
| 2026-06-14 | v2.3 ✅ | 代码模板化重构完成，达到 1,052,009 msg/s |
...
- 吞吐量：**1,052,009 msg/s**（+0.9% vs v2.3 直接解析）
- 10次重放稳定：1,052,009 msg/s
